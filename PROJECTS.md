...
| Path | Role |
| --- | --- |
| `src/` | Dark Ralph TUI source: CLAWD market view, agent loop, Solana services, and terminal UI. |
...
| `cloudflare-agent-api/` | Cloudflare runtime/API layer for deployable agent services. |
| `llm-wiki-tang/` | Knowledge/wiki material for LLM-readable project context. |
...
Geoff Huntley's OODA harness pattern, Clawd, CLAWD bot commit context, Solana,
and x402.
